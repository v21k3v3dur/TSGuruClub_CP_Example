...
namespace GC_CustomPropertyLibrary._03_EPDProperties
{
    ...
    [ExportMetadata("CustomProperty","CUSTOM.GC_EPD_NUMBER")]
    public class EpdNumberCustomProperty: ICustomPropertyPlugin
    {
        ...
        public string GetStringProperty(int objectId)
        {
            ...
            if (elementType != "")
            {
                string result = EpdDataHandler.GetEpdNumber(elementType);
